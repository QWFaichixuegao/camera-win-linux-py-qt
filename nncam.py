...
NNCAM_FLAG_LIGHTSOURCE         = 0x0000080000000000  # light source
NNCAM_FLAG_FILTERWHEEL         = 0x0000100000000000  # filter wheel
...
NNCAM_EVENT_AFFEEDBACK         = 0x0083          # auto focus information feedback
...
NNCAM_OPTION_DEMOSAIC               = 0x12       # demosaic method for both video and still image: BILINEAR = 0, VNG(Variable Number of Gradients) = 1, PPG(Patterned Pixel Grouping) = 2, AHD(Adaptive Homogeneity Directed) = 3, EA(Edge Aware) = 4, see https://en.wikipedia.org/wiki/Demosaicing, default value: 0
...
NNCAM_OPTION_AFMODE                 = 0x25       # auto focus mode (0:manul focus; 1:auto focus; 2:once focus; 3:conjugate calibration)
...
NNCAM_OPTION_PRECISE_FRAMERATE      = 0x2d       # precise frame rate current value in 0.1 fps, range:[1~maximum]
NNCAM_OPTION_BANDWIDTH              = 0x2e       # bandwidth, [1-100]%
NNCAM_OPTION_RELOAD                 = 0x2f       # reload the last frame in trigger mode
NNCAM_OPTION_CALLBACK_THREAD        = 0x30       # dedicated thread for callback
...
NNCAM_OPTION_OPEN_USB_ERRORCODE     = 0x3b       # get the open usb error code
...
NNCAM_OPTION_AUTOEXPOSURE_PERCENT   = 0x4a       # auto exposure percent to average:
                                                   ...
                                                   #
NNCAM_OPTION_ANTI_SHUTTER_EFFECT    = 0x4b       # anti shutter effect: 1 => disable, 0 => disable; default: 1
...
NNCAM_FRAMEINFO_FLAG_SEQ            = 0x0001   # frame sequence number
NNCAM_FRAMEINFO_FLAG_TIMESTAMP      = 0x0002   # timestamp
NNCAM_FRAMEINFO_FLAG_EXPOTIME       = 0x0004   # exposure time
NNCAM_FRAMEINFO_FLAG_EXPOGAIN       = 0x0008   # exposure gain
NNCAM_FRAMEINFO_FLAG_BLACKLEVEL     = 0x0010   # black level
NNCAM_FRAMEINFO_FLAG_SHUTTERSEQ     = 0x0020   # sequence shutter counter
NNCAM_FRAMEINFO_FLAG_STILL          = 0x8000   # still image
...
NNCAM_IOCONTROLTYPE_GET_INPUTACTIVATION       = 0x09  # 0x00 => Rising edge, 0x01 => Falling edge
...
NNCAM_BRIGHTNESS_MIN           = -64      # brightness
NNCAM_BRIGHTNESS_MAX           = 64       # brightness
NNCAM_CONTRAST_DEF             = 0        # contrast
NNCAM_CONTRAST_MIN             = -100     # contrast
NNCAM_CONTRAST_MAX             = 100      # contrast
...
NNCAM_BLACKLEVEL8_MAX          = 31       # maximum black level for bit depth = 8
NNCAM_BLACKLEVEL10_MAX         = 31 * 4   # maximum black level for bit depth = 10
NNCAM_BLACKLEVEL12_MAX         = 31 * 16  # maximum black level for bit depth = 12
NNCAM_BLACKLEVEL14_MAX         = 31 * 64  # maximum black level for bit depth = 14
NNCAM_BLACKLEVEL16_MAX         = 31 * 256 # maximum black level for bit depth = 16
...
NNCAM_TEC_TARGET_MIN           = -500     # TEC target: -50.0 degrees Celsius
NNCAM_TEC_TARGET_DEF           = 0        # TEC target: 0.0 degrees Celsius
NNCAM_TEC_TARGET_MAX           = 400      # TEC target: 40.0 degrees Celsius
NNCAM_HEARTBEAT_MIN            = 100      # millisecond
NNCAM_HEARTBEAT_MAX            = 10000    # millisecond
NNCAM_AE_PERCENT_MIN           = 0        # auto exposure percent, 0 => full roi average
NNCAM_AE_PERCENT_MAX           = 100
NNCAM_AE_PERCENT_DEF           = 10
...
NNCAM_DYNAMIC_DEFECT_T1_MIN    = 10       # dynamic defect pixel correction
NNCAM_DYNAMIC_DEFECT_T1_MAX    = 100
NNCAM_DYNAMIC_DEFECT_T1_DEF    = 13
NNCAM_DYNAMIC_DEFECT_T2_MIN    = 0
NNCAM_DYNAMIC_DEFECT_T2_MAX    = 100
NNCAM_DYNAMIC_DEFECT_T2_DEF    = 100
...
class Nncam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 54.22587.20230516"""
        cls.__initlib()
    ...
    def Replug(cls, id):
        ...
        """
        if sys.platform == 'win32':
            return cls.__lib.Nncam_Replug(id)
        else:
            return cls.__lib.Nncam_Replug(id.encode('ascii'))
    ...
    def __initlib(cls):
        if cls.__lib is None:
            ...
            cls.__lib.Nncam_EnumV2.argtypes = [_DeviceV2 * NNCAM_MAX]
            cls.__lib.Nncam_EnumWithName.restype = ctypes.c_uint
            cls.__lib.Nncam_EnumWithName.argtypes = [_DeviceV2 * NNCAM_MAX]
